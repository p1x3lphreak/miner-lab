#!/usr/bin/env bash
# ============================================================
#  Miner-Lab Component Installer: xmrig-summary
# ============================================================
...
SERVICE_SRC="$INSTALL_DIR/services/xmrig-summary/xmrig-summary.service"
TIMER_SRC="$INSTALL_DIR/services/xmrig-summary/xmrig-summary.timer"
ENV_FILE="/etc/miner-lab/.env"
LOG_DIR="/var/log/miner-lab"
USER_NAME="minerlab"
VENV_DIR="$INSTALL_DIR/venv"

log "Installing xmrig-summary service and timer..."
...
# Enable & start
systemctl enable --now xmrig-summary.timer

log "xmrig-summary installed and timer activated."
