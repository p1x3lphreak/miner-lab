#!/usr/bin/env bash
# ============================================================
#  Miner-Lab Component Installer: miner-syncd
# ============================================================
...
SERVICE_SRC="$INSTALL_DIR/services/miner-syncd/miner-syncd.service"
SERVICE_DEST="$SYSTEMD_DIR/miner-syncd.service"
ENV_FILE="/etc/miner-lab/.env"
LOG_DIR="/var/log/miner-lab"
USER_NAME="minerlab"
VENV_DIR="$INSTALL_DIR/venv"

log "Installing miner-syncd service..."
...
# Enable & start
systemctl enable --now miner-syncd.service

log "miner-syncd installed and running."
systemctl status miner-syncd.service --no-pager || true